...
There are currently 88 polls in the CSV, I will try to see if I can add more (wrote "done" in the chart below for the pollsters that I checked to make sure that I included all compatible polls).
